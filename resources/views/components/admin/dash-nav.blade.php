    ...
    <div class="flex flex-wrap justify-between items-center">
        <div class="flex justify-start items-center">
            ...
            <a href="https://flowbite.com" class="flex items-center justify-between mr-4">
                <img src="https://cdnb.artstation.com/p/assets/images/images/073/116/871/original/vert-glt-render-gif-1.gif?1708960704" class="mr-3 h-8" alt="Flowbite Logo" />
                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Admin Layout</span>
            </a>
        ...
        <div class="flex items-center lg:order-2">
            ...
            <button type="button"
                ...
                <img class="w-8 h-8 rounded-full"
                    src="https://cdnb.artstation.com/p/assets/images/images/073/116/871/original/vert-glt-render-gif-1.gif?1708960704"
                    alt="user photo" />
            </button>
            <!-- Dropdown menu -->
